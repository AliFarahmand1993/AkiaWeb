...
class DUPX_Bootstrap
{
	...
	const ARCHIVE_FILENAME	 = 'new_backuo_1401_902004a2d670f8663900_20220828082740_archive.zip';
	const ARCHIVE_SIZE		 = '169709468';
	const INSTALLER_DIR_NAME = 'dup-installer';
	const PACKAGE_HASH		 = '902004a-28082740';
    const SECONDARY_PACKAGE_HASH = 'b76efc7-28082740';
	const VERSION			 = '1.4.5';
