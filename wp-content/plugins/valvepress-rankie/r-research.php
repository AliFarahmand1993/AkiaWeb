...
function rankie_research() {
	...
	<h2>جست و جوي کلمات کليدي</h2>
	
	<table style="margin-top:10px;width:100%;max-width: 900px;">
		<tbody>
		<tr>
			
			<td><input style="width:100%" type="text" value="" autocomplete="off" placeholder="کلمه کليدي ..." size="14" class="newtag form-input-tip" id="wp_keyword_tool_search_txt"></td>
			<td style="width: 135px;" ><input style="width:100%"  type="button" tabindex="3" value="جستوجو" class="button" id="wp_keyword_tool_more"></td>
		...
		<tr><td colspan="3">
			...
			<div class="hidden" id="wp_keyword_tool_body">
				...
				<div style="margin-bottom:10px;padding-left:5px"><label><input type="checkbox" id="wp_keyword_tool_check" value="s">علامت زدن/برداشتن علامت همه</label></div>
				
				<input type="button"   value="نمايش به صورت ليست" class="button" id="wp_keyword_tool_list_btn">
				
				<p>
					ابزار جستوجو  (<span class="wp_keyword_tool_count"></span>) کلمه کليدي را براي عبارت 
				(<span class="wp_keyword_tool_keyword_status"></span>) پيدا کرده.
