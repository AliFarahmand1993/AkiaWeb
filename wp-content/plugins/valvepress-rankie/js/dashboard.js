	...
	jQuery('#rankie-keywords_wrapper').on('click','.rankie-keyword-text', function(){
	    ...
	    jQuery.ajax({
			            ...
			            success: function(data){
			                  ...
			                  var options = {	
			                		  			title: " (" + itemKeyword + ") - (" + itemSite + ") - رتبه بندی سوابق  " ,
			                                    width: jQuery('#chart_div').width() - 10 , height: 190,
			                          vAxis: { title:"رتبه" ,direction:-1, viewWindowMode:"pretty"},
			                          titleTextStyle : {bold:false},
			                          hAxis:{title : "تاریخ را تغییر دهید"}
