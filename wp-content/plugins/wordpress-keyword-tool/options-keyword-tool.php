...
if(isset($_POST['wp_keyword_tool_google'])){
 ...
 //Farsi
 $allletters['Farsi'] = array("۱", "۲", "۳", "۴", "۵", "۶", "۷", "۸", "۹", "۰", "ض", "ص", "ث", "ق", "ف", "غ", "ع", "ه", "خ", "ح", "ج", "چ", "ش", "س", "ی", "ب", "ل", "ا", "ت", "ن", "م", "ک", "گ", "ظ", "ط", "ز", "ر", "ذ", "د", "پ", "و", "ژ", "ئ", "آ");
 //French
                        	      	...
                        	      	<div class="TTWForm">                     
										...
										<div style="float:left;width:33%" id="field-wp_keyword_tool_alphabets-container" class="field f_100" >
											<label for="field-wp_keyword_tool_alphabets">
												<?php _e('Language letters','wp_keyword_tool') ?>
											</label>
										...
										<div style="float: left; display: inline; width: 30%; margin-left: 10px;margin-top:20px">
                        	      		...
                        	      		<div  class="field f_100">
                        	      			<label>
                        	      			    <?php _e('Supported post types(comma separated) :','wp_keyword_tool') ?>
                        	      			</label>
